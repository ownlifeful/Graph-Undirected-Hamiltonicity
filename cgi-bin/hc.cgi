...
print start_form(
    -name   => 'mainForm',
    -action => url( -absolute => 1, -path_info => 0 )
);
...
sub get_textarea {
    ...
    my $result = '';
    $result
        .= qq{<DIV style="background-color: #DDD; padding-top: 10px; padding-bottom: 10px;">\n};
    $result
        .= qq{<div style="padding-top: 10px; padding-bottom: 10px; padding-left: 20px;">\n};
    $result .= textarea(
        -name        => 'graph_text',
    ...
    $result
        .= qq{<div style="padding-top: 10px; padding-bottom: 10px; padding-left: 20px; padding-right: 10px;">\n};
    $result .= submit(
        -style => q{
                   color: #fff;
