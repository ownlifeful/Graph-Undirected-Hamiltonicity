...
use Graph::Undirected::Hamiltonicity::Transforms qw(&string_to_graph &delete_unusable_edges);
...
my @tests = (
    ...
    },
    {
        ...
        expected_output_graph_text => '0=1,0=4,10=11,10=9,11=7,1=2,2=3,3=5,4=6,5=7,6=8,8=9',
    },
...
foreach my $test ( @tests ) {
    ...
    is( $deleted_edges, $test->{expected_deleted_edges}, "Deleted the expected number of unusable edges.");
    is( "$output_graph", $test->{expected_output_graph_text}, "Deleted all the unusable edges expected.");
}
